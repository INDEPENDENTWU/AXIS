...
/* 8.19 closes its historical release identity first. 8.20 then layers the next
   product contract. 8.20.1 reliability hardening runs before the current public
   release seal so runtime behavior is tested without relabeling historical 8.19. */

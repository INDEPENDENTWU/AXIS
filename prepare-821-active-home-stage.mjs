...
/*
 * Active Home becomes an integrated, large-format execution stage without
 * introducing a second Activity truth/action owner. Existing v87 functions and
 * ids remain authoritative for pause/resume, complete-set, add-set and hold-to-
 * finish. This pass changes presentation, hierarchy and motion only.
 */
{
...
.v87Now.axis821ActiveStage[data-status="paused"] .axis821StageStatus i{background:var(--dim);box-shadow:none}.v87Now.axis821ActiveStage[data-status="plan-complete"] .axis821StageStatus i{background:var(--accent2)}
...
.axis821StageControls{display:grid;grid-template-columns:1fr 1.35fr;gap:9px;padding:0 18px 17px}
.axis821StageControls>button{height:60px;border:0;border-radius:18px;transition:transform .13s ease,background .24s ease,color .24s ease,box-shadow .24s ease}.axis821StageControls>button:active{transform:scale(.985)}
...
.v87Now.axis821ActiveStage .v87Add{height:60px;padding:0 18px;border-radius:18px;background:rgba(115,124,255,.12);color:var(--accent2);font-size:13px;font-weight:680}
.v87Now.axis821ActiveStage[data-primary="none"] .axis821StageControls{grid-template-columns:1fr}.v87Now.axis821ActiveStage[data-primary="none"] #v87Toggle{width:100%}
.v87Now.axis821ActiveStage .v87Rest{display:block;min-height:22px;padding:0 18px 12px;text-align:center;color:var(--dim);font-size:10.5px;line-height:1.4}
.v87Now.axis821ActiveStage .v87Paused{display:flex;gap:7px;overflow-x:auto;padding:0 18px 17px;scrollbar-width:none}.v87Now.axis821ActiveStage .v87Paused:empty{display:none}.v87Now.axis821ActiveStage .v87Paused button{height:34px;max-width:220px;padding:0 12px;border:0;border-radius:12px;background:rgba(255,255,255,.045);color:var(--muted);font-size:10.5px}.v87Now.axis821ActiveStage .v87Paused button:before{content:'↩';margin-right:6px;color:var(--accent2)}
...
@keyframes axis821StageIn{from{opacity:0;transform:translateY(10px) scale(.992)}to{opacity:1;transform:none}}
@keyframes axis821SetBump{0%{transform:scale(1);opacity:1}42%{transform:scale(1.035);opacity:.9}100%{transform:scale(1);opacity:1}}
@keyframes axis821StateShift{0%{opacity:.72;transform:translateY(4px)}100%{opacity:1;transform:none}}
@media(max-width:420px){.v87Now.axis821ActiveStage{min-height:322px;border-radius:26px;margin-bottom:18px}.axis821StageHeader{padding-left:15px;padding-right:15px}.axis821StageCore{min-height:172px;padding-left:15px;padding-right:15px}.axis821StageControls{padding-left:15px;padding-right:15px}.axis821StageControls>button{height:58px}.v87Now.axis821ActiveStage .v87Rest,.v87Now.axis821ActiveStage .v87Paused{padding-left:15px;padding-right:15px}.axis821StageClock{font-size:clamp(52px,16vw,68px)}}

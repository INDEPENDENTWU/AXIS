...
console.log('[AXIS 8.21 Active Home stage] PASS · ordinary Active becomes one integrated large Home stage · pause/resume + complete-set are primary · hold-finish preserved · v87 remains sole action owner · postbuild Active-adjust hook preserved · no new storage/writer/Active owner');

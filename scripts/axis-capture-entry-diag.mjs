...
assert.ok(ownerSource.includes('__AXIS_CAPTURE_PREF__')&&ownerSource.includes('openCanonicalCamera(mode,null,false)'),`unexpected capture delegation: ${ownerSource.slice(0,900)}`);
...
console.log('[AXIS capture entry diagnostic] PASS · persisted preference -> canonical delegated camera');

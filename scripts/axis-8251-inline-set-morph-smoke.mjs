...
try{
 ...
 assert.ok(['8.25.1','8.26','8.26.1','8.26.2'].includes(release),`Inline Set Morph proof supports sealed 8.25.1 and inherited successors 8.26/8.26.1/8.26.2, got ${release}`);

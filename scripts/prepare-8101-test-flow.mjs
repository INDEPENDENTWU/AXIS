...
console.log(`[AXIS 8.10.1 test flow] PASS · ${release==='8.12'?'explicit paused rest + 8.12 purpose/method summary with visible fine-tune state':'historical flow preserved'}`);

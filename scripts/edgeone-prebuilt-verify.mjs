...
if(manifest.version!=='8.12.4'||manifest.baseVersion!=='8.12.4')fail(`release drift ${manifest.version}/${manifest.baseVersion}`);
...
console.log('[AXIS EdgeOne prebuilt] verified exact AXIS 8.12.4 canonical artifact; EdgeOne publishes the already-verified runtime without product rebuild');

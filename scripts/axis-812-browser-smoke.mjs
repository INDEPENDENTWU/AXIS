...
try{
 ...
 const d=await page.evaluate(()=>({v:document.documentElement.dataset.axisRuntime,l:window.__AXIS_812_LEARNING__,s:window.__AXIS_812_LEARNING_SETTINGS__,legacy:window.__AXIS_811_LEARNING__,errs:window.__AXIS_ENHANCE_DIAG__?.errors||[]}));
 ...
 await page.click('[data-v812-core="method"][data-v812-value="recall"]');await page.waitForTimeout(80);assert(await page.locator('[data-v812-core="method"][data-v812-value="recall"]').evaluate(el=>el.classList.contains('active')),'recall method preference did not persist');
 ...
 console.log(`[AXIS 8.12 browser] PASS · ${engine} · inline five-decision core + 8.12.2 fine-tune · 25,716-unit diagnostics · 4/8/12 dialogue · no page errors`);

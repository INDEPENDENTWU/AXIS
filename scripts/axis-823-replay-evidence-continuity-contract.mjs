...
if((current.match(/node scripts\/axis-823-replay-evidence-continuity-smoke\.mjs/g)||[]).length!==2)fail('8.23 smoke must run in both Current Release engines');
...
console.log('[AXIS 8.23 Replay Evidence Continuity source contract] PASS · exact Replay→Evidence identity handoff · v815 remains Evidence owner · no new factual/storage/network/AI/media owner');

...
let helperFixes=0,watermarkFixes=0,interactionFixes=0,versionOwnerFixes=0,recordingOwnerFixes=0,retiredOwnerFixes=0;
...
if(recordingOwnerFixes!==3)throw new Error(`AXIS legacy sanitizer: expected 3 recording-owner fixes, found ${recordingOwnerFixes}`);
...
console.log(`[AXIS] recording converged · ${recordingOwnerFixes} core owner fixes · ${retiredOwnerFixes} legacy owner retirements`);

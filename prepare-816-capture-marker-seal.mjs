...
const selectorBroken="$('#v816CaptureMode [data-v816-mode]').forEach";
const selectorFixed="$$('#v816CaptureMode [data-v816-mode]').forEach";
...
if(src.includes(selectorBroken)||src.split(selectorFixed).length-1!==1)fail('Capture selector helper did not converge to the array selector');

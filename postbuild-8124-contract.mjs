...
if(runtime.includes('__AXIS_8201_OBJECT_SYNC__')&&!runtime.includes(executableSetCompletion))fail('8.20.1 runtime must govern set completion by executionMode');
...
console.log('[AXIS 8.12.4 contract] PASS · truthful time semantics · direct Quick Record · actionable read-only Live Route · native Settings vertical geometry · legacy/new set-completion authority compatible');

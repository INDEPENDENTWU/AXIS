...
const css=`
#v87Rest.v89Speak{height:38px!important;min-width:92px!important;display:flex!important;flex:1 1 118px!important;flex-direction:column!important;justify-content:center!important;align-items:stretch!important;gap:1px!important;overflow:hidden!important;cursor:pointer!important;white-space:normal!important;-webkit-tap-highlight-color:transparent!important}
...
#v87Rest.v89Speak .v891RestLine i{font-style:normal!important;color:#9ca4b2!important;font-size:10px!important;line-height:13px!important;font-variant-numeric:tabular-nums!important;white-space:nowrap!important}
#v87Rest.v89Speak .v891RestLine b{display:-webkit-box!important;min-width:0!important;overflow:hidden!important;-webkit-box-orient:vertical!important;-webkit-line-clamp:2!important;white-space:normal!important;text-overflow:clip!important;color:#d2d5dd!important;font-size:10.5px!important;line-height:13px!important;font-weight:650!important;letter-spacing:-.005em!important}
#v87Rest.v89Speak .v891RestMeaning{display:block!important;max-width:100%!important;overflow:hidden!important;text-overflow:ellipsis!important;white-space:nowrap!important;color:#737c89!important;font-size:9px!important;line-height:10px!important}
...
@media(min-width:430px){#v87Rest.v89Speak .v891RestLine b{-webkit-line-clamp:1!important}#v87Rest.v89Speak .v891RestMeaning{line-height:10px!important}}
@media(max-width:380px){#v87Rest.v89Speak{min-width:84px!important;flex-basis:104px!important}.v891SpeakPanel{width:calc(100% - 20px);padding:14px 13px 12px}.v891SpeakPhrase{font-size:18px}.v891SpeakMore>div{grid-template-columns:70px minmax(0,1fr)}}
`;
...
console.log('[AXIS 8.9.1 speak UI] PASS · complete inline rail · explicit learning panel · no autoplay/timer/observer');

...
info.axis811Candidate={
 ...
 learning:{
  owner:'axis_v89_speak',baseEnglish:456,atlasEnglish:5280,totalEnglish:5736,totalUnits:6132,
  availableByLanguage:{en:5736,ja:132,ko:132,zh:132},newMultilingual:{ja:120,ko:120,zh:120},
  legacyDiagnostics:{richEnglish:456,totalUnits:492,phrases:492},exactTargetDuplicates:0,levels:audit.levelCounts,tracks:audit.trackCounts,dialogueTurns:6,connectedSpeech:true,spelling:true,dictation:true,shadow:true,
...
console.log('[AXIS 8.11 experience contract] PASS · 5736 English · 132 JA / 132 KO / 132 ZH · six-turn learning · State Field · inherited diagnostics preserved');
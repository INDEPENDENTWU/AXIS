...
const next='.v873SmartItem.v873SmartCreate{width:100%;min-height:72px;margin:12px 0 4px;padding:14px 46px 14px 16px;box-sizing:border-box;border-radius:16px;background:rgba(115,124,255,.085);display:flex;align-items:center;justify-content:flex-start;text-align:left;position:relative}.v873SmartItem.v873SmartCreate>span{display:block;min-width:0}.v873SmartItem.v873SmartCreate b{display:block;color:var(--accent2);font-size:14px;line-height:1.35;font-weight:650;letter-spacing:0}.v873SmartItem.v873SmartCreate small{display:block;margin-top:5px;color:#747b88;font-size:11px;line-height:1.45;font-weight:400;letter-spacing:0}.v873SmartItem.v873SmartCreate em{position:absolute;right:16px;top:50%;transform:translateY(-50%);color:var(--accent2);font-style:normal;font-size:20px;line-height:1}';
...
const inlineNext="createButton.style.setProperty('display','flex','important');createButton.style.setProperty('visibility','visible','important');createButton.style.setProperty('opacity','1','important');createButton.style.setProperty('width','100%');createButton.style.setProperty('min-height','72px');createButton.style.setProperty('padding','14px 46px 14px 16px','important');createButton.style.setProperty('box-sizing','border-box');createButton.style.setProperty('position','relative')";
...
console.log('[AXIS 8.12.5 smart-create polish] PASS · strict 16px text rail · authoritative 72px card · centered chevron · mature title/subtitle rhythm · no behavior ownership change');

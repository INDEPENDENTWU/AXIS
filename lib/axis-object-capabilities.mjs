...
export const METRIC_CAPABILITIES=Object.freeze({
  ...
  intensity:{id:'intensity',label:'强度',group:'load_device',type:'rating',unit:'',presentation:'rating',min:1,max:20,step:1,repeatability:'single',aggregation:'average',executionHint:'timed',presets:[4,8,12,16,20]},

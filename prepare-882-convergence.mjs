...
/* Quick Record exposes saved custom items and attaches media through app.js's existing capture transaction. */
{
  ...
  for(const token of ['v882QuickMine','v882QuickCustom','quickTypeLabel','quickCustomMeta'])if(!src.includes(token))fail(`v61 source-owned Quick Record missing ${token}`);

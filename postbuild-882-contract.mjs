...
manifest.canonical.sound={owner:'v8710-sound-ui.js',automaticTrigger:'active-item-countdown-zero-only',manualPreview:true,setCue:false,manualFinishCue:false,restCue:false,sessionCue:false};
...
console.log('[AXIS 8.8.2 artifact] PASS · home · local memory · quick media · library · geometry · countdown-only sound · release log');
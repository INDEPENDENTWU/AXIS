...
console.log(`[AXIS inherited 8.8.2] PASS inside ${CURRENT_VERSION} · home · local memory · quick media · library · immutable geometry · sole countdown sound owner · WebKit-safe media store · release log`);
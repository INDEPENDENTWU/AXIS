const CACHE='axis-v70-shell';
const CORE=['/','/index.html','/styles.css','/v61.css','/styles-v7.css','/app.js','/v61.js','/platform-v7.js','/enhance-v7.js','/manifest.webmanifest'];
...
self.addEventListener('fetch',e=>{
  ...
  const fresh=e.request.mode==='navigate'||['/','/index.html','/app.js','/v61.js','/platform-v7.js','/enhance-v7.js','/styles.css','/v61.css','/styles-v7.css'].includes(u.pathname);

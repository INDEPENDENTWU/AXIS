const CACHE='axis-v61-shell';
const CORE=['/','/index.html','/styles.css','/v61.css','/app.js','/v61.js','/manifest.webmanifest'];
...
self.addEventListener('fetch',e=>{
  ...
  const fresh=e.request.mode==='navigate'||['/','/index.html','/app.js','/v61.js','/styles.css','/v61.css'].includes(u.pathname);

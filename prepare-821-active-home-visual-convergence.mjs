 ...
 * visual system around the already-proven v87 controls.
 */
...
html body #v87Now.axis821ActiveStage .axis821StageFinish{height:36px!important;min-width:88px!important;padding:0 12px!important;border:1px solid var(--line2)!important;border-radius:12px!important;background:transparent!important;color:var(--muted)!important;font-size:10.5px!important;font-weight:620!important;box-shadow:none!important}
html body #v87Now.axis821ActiveStage .axis821StageFinish:before{inset:0!important;border-radius:11px!important}
...
s+=`\nwindow.__AXIS_821_ACTIVE_HOME_VISUAL__={version:'8.21',surface:'flat-integrated-home',clock:'centered',controls:'balanced-two-column',adjust:'separate-tertiary-row',stateOwner:'v87',newStorage:false,newWriter:false,newActionOwner:false};\n`;
try{new Function(s)}catch(e){fail(`v87 syntax ${e.message}`)}
fs.writeFileSync(FILE,s);
console.log('[AXIS 8.21 Active Home visual convergence] PASS · flat Home-integrated surface · centered execution clock · balanced controls · isolated Adjust row · v87 ownership unchanged');

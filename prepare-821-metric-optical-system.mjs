...
function functionRange(src,signature,label){
  ...
  return {start,end,text:src.slice(start,end),brace};
}
 ...
 */
{
  ...
  for(const token of ['axis821IntensityKey','axis821OrdinalMetric','data-max="20"','axis821OrdinalRail','[4,8,12,16,20]','axis821MetricFamily(m)','AXIS821_RUNTIME_CAPABILITIES','data-axis821-choice','data-axis821-pace-step'])if(!finalControl.includes(token))fail(`final metric control contract missing ${token}`);
  syntax(s,FILE);
  write(FILE,s);
}
